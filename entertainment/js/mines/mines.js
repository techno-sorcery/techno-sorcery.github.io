        ...
        for (let col = 0; col < width; col++) {
            ...
            if (grid[row][col].uncovered) {
                ...
                if (grid[row][col].number == 9) {
                    ctx.fillText("*", (pixelSize * col) + pixelSize / 5 + 3, (pixelSize * row) - pixelSize / 5 + pixelSize + 5 - 2);
                } else if (grid[row][col].number != 0) {
                    ctx.fillText(grid[row][col].number, (pixelSize * col) + pixelSize / 5 + 3, (pixelSize * row) - pixelSize / 5 + pixelSize - 1);
                }
                ...
                if (grid[row][col].flagged) {
                    ...
                    ctx.fillStyle = "red";
                    ctx.fillText("⚑", (pixelSize * col) + pixelSize / 5, (pixelSize * row) - pixelSize / 5 + pixelSize - 1);
                }
            }
        }
    }
